      ...
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
          ...
          <select id="Position" value={Position || ""} onChange={(e) => setPosition(e.target.value)} className="w-full px-3 py-2 border-b bg-white text-xs" required>
            ...
            <option value="Accounts Payable Associate">Accounts Payable Associate</option>
            ...
            <option value="Asst. Operations Manager">Asst. Operations Manager</option>
            <option value="B2G Account Manager">B2G Account Manager</option>
            ...
            <option value="Digital Specialist">Digital Specialist</option>
            ...
            <option value="IT Asset Supervisor">IT Asset Supervisor</option>
            ...
            <option value="Processing Associate">Processing Associate</option>
            <option value="Product Development Associate">Product Development Associate</option>
            <option value="Product Replacement Associate">Product Replacement Associate</option>
            <option value="Procurement Manager">Procurement Manager</option>
            <option value="Product Development Engineer">Product Development Engineer</option>
            <option value="Product Testing Supervisor">Product Testing Supervisor</option>
            ...
            <option value="Sales Support Supervisor">Sales Support Supervisor</option>
